...
#define mwMalloc(n,f,l)     GxCore_Malloc(n)
#define mwStrdup(p,f,l)     GxCore_Strdup(p)
#define mwRealloc(p,n,f,l)  GxCore_Realloc(p,n)
#define mwCalloc(n,m,f,l)   GxCore_Calloc(n,m)
#define mwFree(p)           GxCore_Free(p)
#define mwMalloc_(n)        GxCore_Malloc(n)
#define mwRealloc_(p,n)     GxCore_Realloc(p,n)
#define mwCalloc_(n,m)      GxCore_Calloc(n,m)
#define mwFree_(p)          GxCore_Free(p)
