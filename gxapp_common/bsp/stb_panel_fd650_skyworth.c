...
/* ---------------------------------------------- */
#include "stb_panel.h"
#if (PANEL_TYPE == PANEL_TYPE_fd650_SKYWORTH)
...
gs_chLedData[LED_DATA_2] = (g_PanelFD650Config.m_chLedBit[BIT_C]);
gs_chLedData[LED_DATA_3] = (g_PanelFD650Config.m_chLedBit[BIT_D]);
gs_chLedData[LED_DATA_4] = (g_PanelFD650Config.m_chLedBit[BIT_E]);
gs_chLedData[LED_DATA_5] = (g_PanelFD650Config.m_chLedBit[BIT_F]);
gs_chLedData[LED_DATA_6] = (g_PanelFD650Config.m_chLedBit[BIT_G]);
gs_chLedData[LED_DATA_7] = (g_PanelFD650Config.m_chLedBit[BIT_P]);
...
{
				//SKYworth
	uint32_t nKeyValue[8]={PANEL_KEY_DOWN
					, PANEL_KEY_UP
					, PANEL_KEY_LEFT
					, PANEL_KEY_RIGHT
					, PANEL_KEY_OK
...
//	g_PanelFD650Config.m_chStandbyPin= 31;
	...
	g_PanelFD650Config.m_nLedAddr[2]=0x1700;
	g_PanelFD650Config.m_nLedAddr[3]=0x1600;
    #if 0
	g_PanelFD650Config.m_nLedAddr[0]=0x1400;
	g_PanelFD650Config.m_nLedAddr[1]=0x1500;
    ...
    #endif
	g_PanelFD650Config.m_nKeyTranslateCode[0]=0x5c;
	g_PanelFD650Config.m_nKeyTranslateCode[1]=0x74;
	g_PanelFD650Config.m_nKeyTranslateCode[2]=0x64;
	g_PanelFD650Config.m_nKeyTranslateCode[3]=0x6c;
	g_PanelFD650Config.m_nKeyTranslateCode[4]=0x75;
	g_PanelFD650Config.m_nKeyTranslateCode[5]=0x65;
	g_PanelFD650Config.m_nKeyTranslateCode[6]=0x5d;
